...
*   **[Power Structure and Statutory Mapping](public-record/power-structure.md):**
    This page tracks the law through the government system. It shows that the Iowa Legislature holds the primary legal authority over this policy, specifically moving through the Health and Human Services (HHS) Committee.
...
*   **[Tactical Map](advocacy/tactical-map.md):**
    A summary of where the system is stuck right now. It outlines the current operational status of HF 385 as it transitions through the legislative lifecycle.
